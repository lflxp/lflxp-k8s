    ...
    >
      ...
      <el-table-column label="Image" width="200">
        <template slot-scope="scope">
          ...
          <div v-if="scope.row.spec.jobTemplate.spec.template.spec.containers.length > 1">
            <br/>
            <el-button type="text">+{{ scope.row.spec.jobTemplate.spec.template.spec.containers.length }} more</el-button>
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Last Schedule" align="center">
        <template slot-scope="scope">
          <div v-if="scope.row.status.aa !== undefined">Ok</div>
