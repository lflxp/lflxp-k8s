export default {
  ...
  children: [
    ...
    {
      path: '/demo/playground/workload',
      title: '工作负载',
      icon: 'globe',
      children: [
        { path: '/demo/playground/workload/pods', title: 'Pods', iconSvg: 'd2-admin' },
        { path: '/demo/playground/workload/deployments', title: 'Deployments', iconSvg: 'd2-admin' },
        { path: '/demo/playground/workload/daemonsets', title: 'Daemonsets', iconSvg: 'd2-admin' },
        { path: '/demo/playground/workload/statefulsets', title: 'Statefulsets', iconSvg: 'd2-admin' },
        { path: '/demo/playground/workload/cronjobs', title: 'Cronjobs', iconSvg: 'd2-admin' },
        { path: '/demo/playground/workload/jobs', title: 'Jobs', iconSvg: 'd2-admin' },
      ]
    },
    {
      path: '/demo/playground/service',
      title: '服务发现',
      icon: 'globe',
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/demo/playground/frame/apiresources', title: 'APIResource', icon: 'code' },
      ]
    },
    {
      title: '新窗口打开链接',
