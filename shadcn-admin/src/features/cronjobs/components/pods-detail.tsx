...
import Active from "./basic/active"
      ...
      <DrawerContent>
        ...
        <TabsList className="grid w-full grid-cols-6 gap-2">
          <TabsTrigger value="container">
            ...
            <Avatar className="h-5 w-5 ml-1">
              <AvatarFallback className="text-xs">
                {currentRow.crd.spec.jobTemplate.spec.template.spec.containers?.length || 0 }
              </AvatarFallback>
            </Avatar>
          </TabsTrigger>
          <TabsTrigger value="active">
            ...
            <Avatar className="h-5 w-5 ml-1">
              <AvatarFallback className="text-xs">
                {currentRow?.crd?.status?.active ? currentRow.crd.status.active.length : 0}
              </AvatarFallback>
            </Avatar>
          </TabsTrigger>
          ...
          <TabsTrigger value="status">
            ...
            <Avatar className="h-5 w-5 ml-1">
              <AvatarFallback className="text-xs">
                {currentRow?.crd?.status?.conditions ? Object.keys(currentRow?.crd.status?.conditions).length : 0}
              </AvatarFallback>
            </Avatar>
          </TabsTrigger>
        ...
        <TabsContent value="active" className="h-[80vh] overflow-y-auto">
          <Active currentRow={currentRow} />
        </TabsContent>
